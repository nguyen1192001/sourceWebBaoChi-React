...
function AccountManage() {
    ...
    let [accountRender,setAccountRender] = useState((newAccounts).slice(start,end))
    ...
    const listAccountSearch = (e)=>{
        ...
        renderList =  accounts.filter((item)=>{
         ...
         renderList == null ? setAccountRender(accountRender): setAccountRender(renderList)
    }
                ...
                <div className="box-panel">
                    <div className="header_search boxAdmin">
                        <div className="header_search-ip">
                            <input name='email' onChange={listAccountSearch} type="text" placeholder="Nhập nội dung tìm kiếm" defaultValue />
                        </div>
